                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px solid #4db8ff; padding: 10px;">
                                <form action="{{ route('destroyUser', $user->id) }}" method="post" style="display: flex; justify-content: space-between;">
                                    ...
                                    <button type="submit"  onclick="return confirm('¿Quieres Borrar este producto?');" style="background-color: #ff4d4d; color: #fff; border-radius:5px; flex: 1; text-align: center; padding: 5px; padding-right:20px"> Borrar</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
